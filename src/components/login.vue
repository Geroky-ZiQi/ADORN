  ...
  <div class="wrapper">
  					...
  					<div class="btm_bar_content">
  						<nav>
  							<ul>
  								<li><a href="#" title=""> MY 我的  </a>
  									<div class="mega-menu">
  										<ul>
  											...
  											<li><a href="Upload_Video.html" title="">上传记录</a></li>
  								...
  								<li><a href="Browse_Categories.html" title=""> CATEGORIES 分类 </a></li>
  	...
  	<section class="form_popup">
  		...
  		<div class="login_form" id="login_form">
  			...
  			<div class="fr-ps">
  				<h1>还没有账号？ <a href="signup.html" title="" class="show_signup">点击注册</a></h1>
  			</div><!--fr-ps end-->
  		</div><!--login end-->
